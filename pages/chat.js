        ...
        >
            ...
            >
                ...
                >
                    ...
                    {/* {listaDeMensagem.map((mensagemDigitada) => {
                        return (
                            <li key={mensagemDigitada.id}>
                                {mensagemDigitada.de} : {mensagemDigitada.texto}
                            </li>
                        )
                    })} */}
                    ...
                    >
                        <TextField
                            value={mensagem}
                            onChange={(event) => {
                                //pegando mensagem digitada na caixa de texto
                            ...
                            onKeyPress={(event) => {
                                ...
                                if (event.key === 'Enter') {
                                    //evita que o enter pule a linha
